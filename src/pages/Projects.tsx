...
const completeApps = [
  {
    title: "thready-js - JavaScript Multithreading Library",
    description: "Open-source NPM library with 10k+ downloads. Type-safe thread-pool abstraction for Web Workers and Node.js worker_threads with zero dependencies. Demonstrates deep understanding of JavaScript's event loop and worker model.",
    image: "/thready.png",
    technologies: ["TypeScript", "NPM Package", "Web Workers", "Node.js"],
  ...
  },
  {
    ...
    liveUrl: "https://warehouse-management-system-lovat.vercel.app/",
    githubUrl: "https://github.com/imramkrishna/WarehouseManagementSystem",
  },
  {
    ...
    liveUrl: "https://x-code-gen.vercel.app/",
    githubUrl: "https://github.com/imramkrishna/XCodeGen",
  },
];
